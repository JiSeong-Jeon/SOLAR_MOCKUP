...
import { User, Bell, Moon, HelpCircle, FileText, LogOut, ChevronRight, FolderOpen } from 'lucide-react';
...
export function SettingsPage({ view = 'main', onViewChange }: SettingsPageProps) {
  ...
  const handleQuietHoursToggle = () => {
    ...
    toast.success(newState ? '조용 시간이 설정되었어요' : '조용 시간이 해제되었어요');
  };
  ...
  return (
    <div className="pb-20 pt-4 px-4 max-w-lg mx-auto">
        ...
        <Dialog open={isEditingNickname} onOpenChange={setIsEditingNickname}>
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleSaveNickname} className="bg-[#3751FF] hover:bg-[#3751FF]/90">
                저장
              </Button>
            </DialogFooter>
          </DialogContent>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={() => handleNotificationToggle('activityReminder')}
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-xs text-neutral-500">설정한 시간에는 알림을 받지 않아요</p>
              </div>
              <Switch
            ...
            {quietHours.enabled && (
              <div className="grid grid-cols-2 gap-3 mt-3 p-3 bg-neutral-50 rounded-lg">
                <div>
                  <Label htmlFor="quiet-start" className="text-xs text-neutral-600">
                    시작
                  </Label>
                  <Input
                    id="quiet-start"
                ...
                <div>
                  <Label htmlFor="quiet-end" className="text-xs text-neutral-600">
                    종료
                  </Label>
                  <Input
                    id="quiet-end"
      ...
      <Card className="p-5 mb-4">
        <button
          onClick={() => toast('로그아웃 기능은 데모에서 제공되지 않아요')}
